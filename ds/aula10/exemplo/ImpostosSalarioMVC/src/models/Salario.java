...
public class Salario {
	...
	public String toString() {
		return "Salario [matricula=" + matricula + ", funcionario=" + funcionario + ", salario=" + String.format("%.2f", salario)
				+ ", INSS=" + String.format("%.2f", getINSS()) + ", SalarioBase=" + String.format("%.2f", getSalarioBase()) + "]";
	}
